...
export class UserRepository {
  ...
  public async update(filters: Prisma.UserWhereUniqueInput, data: Prisma.UserUpdateInput): Promise<User> {
    return await this.prisma.user.update({ where: filters, data: data });
  };
};